...
{$IFDEF DELPHI2009UP}
 ComboSeparators.Items.Add(SRpDate+' '+FormatSettings.DateSeparator);
 ComboSeparators.Items.Add(SRpTime+' '+FormatSettings.TimeSeparator);
 ComboSeparators.Items.Add('Decimal'+' '+FormatSettings.DecimalSeparator);
 ComboSeparators.Items.Add('Thousand'+' '+FormatSettings.ThousandSeparator);
{$ELSE}
...
{$ENDIF}
 ...
 begin
  ...
  begin
   ...
   // Bug fix for Delphi 2010 and up
   // Get printer dc again
   dc:=Printer.Handle;
 ...
 begin
  if osinfo.dwPlatformId=VER_PLATFORM_WIN32_NT then
   LOS.Caption:='Windows NT/XP/Vista/2003/2008/7/8'
  else
