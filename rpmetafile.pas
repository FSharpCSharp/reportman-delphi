...
type
 ...
 TFlexStream=class(TStream)
  private
   ...
   critsec:SyncObjs.TCriticalSection;
   procedure ReadBuffer;
  public
   function Write(const Buffer; Count: Longint): Longint;override;
   function Read(var Buffer; Count: Longint): Longint; override;
   function Seek(Offset: Longint; Origin: Word): Longint; override;
   constructor Create(AStream:TStream;OnRequestData:TOnRequestData;criticalsec:SyncObjs.TCriticalSection);
...
{$ENDIF}
 ...
 TRpMetafilePage=class(TObject)
  private
   ...
   CritEx:SyncObjs.TCriticalSection;
...
begin
 ...
 FPoolPos:=1;
 FStreamPos:=0;
 CritEx:=SyncObjs.TCriticalSection.Create;
...
begin
 ...
 critsec:=SyncObjs.TCriticalSection.Create;
 FCurrentPage:=-1;
 FMemStream:=TMemoryStream.Create;
...
constructor TFlexStream.Create(AStream:TStream;OnRequestData:TOnRequestData;criticalsec:SyncObjs.TCriticalSection);
begin
 critsec:=criticalsec;
