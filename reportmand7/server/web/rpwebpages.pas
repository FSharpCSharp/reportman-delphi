...
begin
 Ffilenameconfig:='';
 try
  Ffilenameconfig:=Obtainininamecommonconfig('','','reportmanserver',false);
  if (FileExists(ffilenameconfig)) then
   raise Exception.Create('File does not exists: '+ffilenameconfig);
