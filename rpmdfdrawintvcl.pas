   ...
   case aimage.DrawStyle of
    ...
    rpDrawCrop:
     begin
         recsrc.Left:=0;
         recsrc.Top:=0;
         recsrc.Right:=fbitmap.Width-1;
         recsrc.Bottom:=fbitmap.Height-1;
         propx:=(rec.Right-rec.Left)/fbitmap.Width;
         propy:=(rec.Bottom-rec.Top)/fbitmap.Height;
         if (propy>propx) then
         begin
         ...
         DrawBitmap(Canvas,fbitmap,rec,recsrc);
      //rec
