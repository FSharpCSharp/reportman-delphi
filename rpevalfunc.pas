...
// On Brazilian Portuguese we use a lot �, �, �, etc. and it wasn't
...
begin
  ...
  for i := 1 to Length(StrTemp) do begin
    ...
    if (NrChr = 199) then begin  //�
      StrRet := StrRet + 'C';
      Continue;
    end;
    if (NrChr = 231) then begin  //�
      StrRet := StrRet + 'c';
      Continue;
    end;
    if (NrChr = 209) then begin  //�
      StrRet := StrRet + 'N';
      Continue;
    end;
    if (NrChr = 241) then begin  //�
      StrRet := StrRet + 'n';
      Continue;
    end;
    if ((NrChr = 176) or (NrChr = 186)) then begin  //� ou �
      StrRet := StrRet + 'o';
      Continue;
    end;
    if (NrChr = 170) then begin  //�
      StrRet := StrRet + 'a';
      Continue;
    end;
